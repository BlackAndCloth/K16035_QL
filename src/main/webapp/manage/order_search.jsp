...
<div id="body">
    ...
    -->
    <div id="middle">
        <form action="${pageContext.request.contextPath}/manage/ordersActionM!searchOrders.action" method="post">
            <table align="center" border="1" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="right"><input type="text" name="disheName" /></td>
                </tr>
                <tr>
                    <td class="left">按销售日期查询</td>
                    <td class="right"><input type="date" name="order.dateTime" />
            ...
            <c:if test="${pageSum > 0}">
                <tr class="head">
                    <td colspan="12">共${pageSum}页
                        <a href="${pageContext.request.contextPath}/manage/ordersActionM!selectOrdersPage.action?page=1">[首页]</a>
                        <c:forEach var="pageNum" begin="1" end="${pageSum }">
                            <a href="${pageContext.request.contextPath}/manage/ordersActionM!selectOrdersPage.action?page=${pageNum}">${pageNum}</a>
                        </c:forEach>
                        <a href="${pageContext.request.contextPath}/manage/ordersActionM!selectOrdersPage.action?page=${pageSum}">[尾页]</a>
                    </td>
                </tr>
            </c:if>
        </table>
