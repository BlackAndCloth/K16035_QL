	...
	<body onload="setTitle()">
		...
		<div id="background">
			...
			<div id="middle_notice">
				<br/>
				<p align="center" style="font-size: 24px;"><b>${notice.title}</b></p>
				<br/>
				<p align="center" style="font-size: 20px;">${notice.dateTimes}</p>
				<br/>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${notice.content}</p>
				<br/>
				<p align="center">
					<a href="${pageContext.request.contextPath}/proscenium/noticeAction!selectNoticeAll.action">返回</a>
				</p>
			</div>
			<!--
        	时间：2017-03-11
